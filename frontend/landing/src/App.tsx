...
export default function App() {
  ...
  useEffect(() => {
    ...
    function tick() {
      ...
      } else if (duration && currentTime > duration - FADE_DURATION) {
    ...
    <div className="relative min-h-screen w-full overflow-hidden bg-white">
      ...
      <nav className="relative z-10">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-8 py-6">
          ...
          >
            Aethera<sup style={{ fontSize: '0.55em', verticalAlign: 'super' }}>®</sup>
          </span>
      ...
      >
        ...
        >
          Beyond{' '}
          <em className="not-italic" style={{ color: '#6F6F6F', fontStyle: 'italic' }}>
            silence,
          </em>{' '}
          we build{' '}
          <em className="not-italic" style={{ color: '#6F6F6F', fontStyle: 'italic' }}>
        ...
        <button
          className="animate-fade-rise-delay-2 mt-12 rounded-full px-14 py-5 text-base font-medium text-white transition-transform duration-200 hover:scale-[1.03]"
          style={{ backgroundColor: '#000000', fontFamily: "'Inter', sans-serif" }}
        >
          Begin Journey
        </button>
